...
SELECT departments.dept_no, departments.dept_name, dept_managers.emp_no, dept_managers.from_date, dept_managers.to_date,
employees.first_name, employees.last_name FROM employees
